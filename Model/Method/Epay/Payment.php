 ...
 *
 */
namespace Duitku\Nobuqris\Model\Method\Epay;
...
class Payment extends \Duitku\Nobuqris\Model\Method\AbstractPayment
{
    ...
    protected $_infoBlockType = 'Duitku\Nobuqris\Block\Info\View';
    ...
    /**
     * @var \Duitku\Nobuqris\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Nobuqris\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Nobuqris\Model\Api\Epay\Request\Payment
     */
     ...
     * @return \Duitku\Nobuqris\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayNobuqris/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayNobuqris/cancel', ['_secure' => $this->_request->isSecure()]);
    }
