...
{
    /**
     * @var \Duitku\Nobuqris\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\Nobuqris\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\Nobuqris\Logger\DuitkuLogger $duitkuLogger,
	...
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Nobuqris_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Nobuqris")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Nobuqris\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
